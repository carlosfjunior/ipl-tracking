...
public final class Messages {
	...
	public static final String CUSTOMER_OWNER_ASSOCIATION_FAILED_CUSTOMER_NOT_FOUND = "Target Customer not found. It's not possible to associate to a vehicle. CustomerOwner ID: %s";
